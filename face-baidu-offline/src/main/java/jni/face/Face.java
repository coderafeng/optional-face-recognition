package jni.face;
import jni.struct.TrackFaceInfo;
import jni.struct.Attribute;
import jni.struct.RgbDepthInfo;
import jni.struct.EyeClose;
import jni.struct.FaceBox;
import jni.struct.Feature;
import jni.struct.FeatureInfo;
import jni.struct.GazeInfo;
import jni.struct.HeadPose;
import jni.struct.Landmarks;
import jni.struct.LiveFeatureInfo;
import jni.struct.LivenessInfo;
import jni.struct.Occlusion;
